...
| v0.4 | Prototype Hardening | Add notifications, local persistence, error handling, analytics, and release-quality polish. | 10-16h | in progress: persistence, native smoke coverage, and registration slice landed; dev-client migration is scaffolded but blocked on a Windows path-length native build issue | |
